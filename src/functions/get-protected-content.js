const content = {
	...
	pro: {
		...
		message:
			'This is protected content! It is only available if you have a pro plan or higher.',
	...
	premium: {
		...
		message:
			'This is protected content! It is only available if you have the premium plan.',
